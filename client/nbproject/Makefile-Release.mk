...
${OBJECTDIR}/arguments_impl.o: arguments_impl.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arguments_impl.o arguments_impl.c
...
${OBJECTDIR}/enviar_rebre_dades_comandes_impl.o: enviar_rebre_dades_comandes_impl.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/enviar_rebre_dades_comandes_impl.o enviar_rebre_dades_comandes_impl.c
...
${OBJECTDIR}/subscripcio_impl.o: subscripcio_impl.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/subscripcio_impl.o subscripcio_impl.c
